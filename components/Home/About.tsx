  ...
  return (
    ...
    >
      <div className="relative max-w-[622px] h-max flex flex-col gap-1">
        ...
        <div className="w-fit flex my-4 flex-col rounded border bg-background/25 border-background/25 dark:border-foreground/10 dark:bg-foreground/10 shadow backdrop-blur-xl">
          <div className="border-b flex justify-between border-background/25 dark:border-foreground/10 p-1 sm:p-2 pl-2 text-left font-code text-[.5rem] sm:text-xs">
